...
if(function_exists("register_field_group"))
{
	register_field_group(array (
		...
		'fields' => array (
			array (
				'key' => 'field_5ad7d083624a7',
				'label' => 'Introduction Panel Text',
				'name' => '',
				'type' => 'tab',
			),
			array (
				'key' => 'field_5ad7d0a2624a8',
				'label' => 'Service Title Main',
				'name' => 'cc_service_title_main',
				'type' => 'text',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5ad7d0b9624a9',
				'label' => 'Service Title Description',
				'name' => 'cc_service_title_description',
				'type' => 'textarea',
				'default_value' => '',
				'placeholder' => '',
				'maxlength' => '',
			...
			array (
				'key' => 'field_5ad7d0cf624aa',
				'label' => 'Service Title One',
				'name' => 'cc_service_title_one',
				'type' => 'text',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5ad7d0de624ab',
				'label' => 'Service Text One',
				'name' => 'cc_service_text_one',
				'type' => 'textarea',
				'default_value' => '',
				'placeholder' => '',
				'maxlength' => '',
			...
			array (
				'key' => 'field_5ad7d0ed624ac',
				'label' => 'Service Title Two',
				'name' => 'cc_service_title_two',
				'type' => 'text',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5ad7d0f8624ad',
				'label' => 'Service Text Two',
				'name' => 'cc_service_text_two',
				'type' => 'textarea',
				'default_value' => '',
				'placeholder' => '',
				'maxlength' => '',
			...
			array (
				'key' => 'field_5ad7d103624ae',
				'label' => 'Service Title Three',
				'name' => 'cc_service_title_three',
				'type' => 'text',
				'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
			...
			array (
				'key' => 'field_5ad7d10d624af',
				'label' => 'Service Text Three',
				'name' => 'cc_service_text_three',
				'type' => 'textarea',
				'default_value' => '',
				'placeholder' => '',
				'maxlength' => '',
